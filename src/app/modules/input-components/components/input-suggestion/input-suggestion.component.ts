...
import {ColumnPositionChangeRequest} from "../../../table-module/table/models/changeRequest/column-position-change.request";
...
export class InputSuggestionComponent implements OnInit {
  ...
  public onTableRowClickEvent(event: TableRowClickEvent) {
    this.owner.inputValue$.next(event.tableRow.data.value);
    this.owner.showSuggestions = false;
  }

  public onOwnerInputEvent(args: SuggestionOwnerInputEvent) {
